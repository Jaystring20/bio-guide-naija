...
export const InviteEmail = ({ confirmationUrl }: InviteEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to VeriDIA</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>You're invited to VeriDIA</Heading>
        <Text style={text}>
          Someone has invited you to join VeriDIA — turn lab results into a
          personalised Nigerian diet plan. Tap below to accept and create your
          account.
        </Text>
