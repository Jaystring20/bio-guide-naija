            ...
            {[
              {
                ...
                tldr: "The AI looks at your photo and writes down every test name, number and unit.",
                pidgin: "AI dey look your lab paper, copy every test name and number wey dey there.",
                body:
              ...
              },
              {
                ...
                tldr: "For each test, we attach a link from a doctor-approved list — the AI never makes up the link.",
                pidgin: "For every test, we go bring link from list wey doctor don approve. AI no fit invent the link.",
                body:
              ...
              },
              {
                ...
                tldr: "Before we suggest any food, we check its nutrition live in the USDA database.",
                pidgin: "Before we recommend any food, we go check am for USDA database make we sure say e correct.",
                body:
              ...
              >
                ...
                <div className="space-y-3 flex-1 min-w-0">
                  ...
                  {/* Quick summaries for fast scanning */}
                  <div className="space-y-1.5">
                    <p className="text-sm text-foreground bg-primary/5 border-l-2 border-primary/60 rounded-r px-3 py-1.5 leading-snug">
                      <span className="text-[10px] font-bold uppercase tracking-wider text-primary mr-1.5">
                        In short
                      </span>
                      {step.tldr}
                    </p>
                    <p
                      lang="pcm"
                      className="text-sm text-foreground bg-secondary/5 border-l-2 border-secondary/60 rounded-r px-3 py-1.5 leading-snug"
                    >
                      <span className="text-[10px] font-bold uppercase tracking-wider text-secondary mr-1.5">
                        Pidgin
                      </span>
                      {step.pidgin}
                    </p>
